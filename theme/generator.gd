...
secondary_2 : Color, secondary_3 : Color, secondary_4 : Color, secondary_5 : Color) -> void:
	...
	#region CalendarWidget
	var calendar_widget := theme.create_theme_type("CalendarWidget", "PanelContainer")

	calendar_widget.panel = {
		"bg_color" = neutral_2,
		"corner_radius" = 6,
		"content_margin" = 12,
	}
	...
	calendar_widget_popup.panel = {
		"bg_color" = neutral_2,
		"corner_radius" = 6,
		"content_margin" = 12,
		"border_width" = 2,
		"border_color" = Color(primary_3, 0.75),
		"shadow_color" = Color(Color.BLACK, 0.2),
		"shadow_size" = 3,
